...
public class SystemBroadcastReceiver extends BroadcastReceiver {
    ...
    public void setSystemBroadcastListener(SystemBroadcastListener systemBroadcastListener){
        this.mSystemBroadcastListener = systemBroadcastListener;
    }
    @Override
    public void onReceive(Context context, Intent intent) {
        if(mSystemBroadcastListener != null){
            mSystemBroadcastListener.onBroadcastReceive();
        }
        ...
        LogHelper.error("SystemBroadcastReceiver---->接收到的系统广播：" + action + ", wifiState = " + wifiState + ",previous state = " + previousWifiState);
